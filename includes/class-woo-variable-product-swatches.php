...
class Woo_Variable_Product_Swatches {
	...
	public function __construct() {
		if ( defined( 'WOO_VARIABLE_PRODUCT_SWATCHES_VERSION' ) ) {
			$this->version = WOO_VARIABLE_PRODUCT_SWATCHES_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'woo-variable-product-swatches';
	 ...
	 *
	 * Uses the Woo_Variable_Product_Swatches_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Woo_Variable_Product_Swatches_i18n();
	 ...
	 *
	 * @since     1.0.0
	 * @return    Woo_Variable_Product_Swatches_Loader    Orchestrates the hooks of the plugin.
	 */
